...
type Config struct {
	...
	PuppetDBUrl    string `short:"u" long:"puppetdb-url" description:"PuppetDB base URL (e.g. https://puppetdb:8081)." env:"PUPPETDB_URL" required:"true" default:"https://puppetdb:8081"`
